              ...
              <div className='shimmer-animation mb-5 rounded-[20px] border border-[#E4E7EC] p-5'>
                ...
                <div className='mt-5 grid gap-3'>
                  {[0, 1, 2, 3, 4].map((_, index) => (
                    <div key={index} className='shimmer-animation h-10 w-full rounded bg-gray-200'></div>
                  ))}
                </div>
              </div>
            ...
            <div>
              <div className='grid gap-5 lg:grid-cols-3'>
                {[0, 1, 2, 3, 4, 5].map((_, index) => (
                  <div key={index} className='shimmer-animation h-[400px] w-full rounded bg-gray-200'></div>
                ))}
              </div>
            </div>
          </div>
