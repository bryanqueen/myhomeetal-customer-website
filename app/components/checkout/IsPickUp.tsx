  ...
  return (
    <div className='absolute top-[50%] min-w-full translate-y-[-50%] px-[3%]'>
      <div
        ...
        className='mt-10 rounded-xl bg-[#f4f4f4] px-5 py-10 lg:mx-auto lg:mt-24 lg:block lg:max-w-4xl lg:rounded-2xl'
      >
        ...
        <div className="h-[200px] mt-3 overflow-y-scroll custom-scrollbar">
          <RadioGroup.Root
